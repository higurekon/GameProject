...
frogwidth = width
frogheight = height
frog_rects = {"hop":[(width*0,height*0,width,height),(width*1,height*0,width,height),(width*2,height*0,width,height),(width*3,height*0,width,height),(width*4,height*0,width,height)],
              "hop full":[(width*0,height*1,width,height),(width*1,height*1,width,height),(width*2,height*1,width,height),(width*3,height*1,width,height),(width*4,height*1,width,height)],
              "birth":[(width*0,height*2,width,height),(width*1,height*2,width,height),(width*2,height*2,width,height),(width*3,height*2,width,height),(width*4,height*2,width,height),(width*5,height*2,width,height),(width*6,height*2,width,height),(width*7,height*2,width,height),(width*8,height*2,width,height)],
              "idle":[(width*0,height*0,width,height)],
              "idle full":[(width*0,height*1,width,height)],
              "eat":[(width*0,height*5,width,height),(width*1,height*5,width,height),(width*2,height*5,width,height),(width*3,height*5,width,height),(width*4,height*5,width,height),(width*5,height*5,width,height),(width*6,height*5,width,height)],
              "croak":[(width*0,height*7,width,height),(width*1,height*7,width,height),(width*2,height*7,width,height),(width*3,height*7,width,height),(width*4,height*7,width,height)],
              "croak full":[(width*0,height*8,width,height),(width*1,height*8,width,height),(width*2,height*8,width,height),(width*3,height*8,width,height),(width*4,height*8,width,height)],
              "hatch":[],
              "born":[],
              "tongue":[]}
...
def main():
    ...
    frog1 = frog(workspace,"/Revision for Line_Frog Without Lines.png", frog_rects,(0,0,0),(int(frogwidth*1.7),int(frogheight*1.7)),int((frogwidth-200)*1.7),int(frogheight*1.7),"right")
